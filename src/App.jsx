...
function App() {
  ...
  return (
    <div
        className="w-screen h-screen flex flex-wrap bg-white bg-cover bg-no-repeat"
        style={{
           // backgroundImage: `url('https://images.pexels.com/photos/3532540/pexels-photo-3532540.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')`,
        }}
    >
        <div className='w-1/2'>
            <img src={Currency} alt="images" />
        </div>
        <div className="w-1/2 h-screen flex justify-center items-center">
           
            <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30 shadow-2xl shadow-red-400">
            <h2 className='font-serif'>Currency Converter</h2>
                <form
                    onSubmit={(e) => {
                        e.preventDefault();
                        convert()
